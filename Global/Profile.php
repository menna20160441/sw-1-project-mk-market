		...
		<div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" action="../Admin/C_Admin.php" method="post">
                            ...
                            <div class="form-group form-group-lg date">
                                ...
                                <div class="col-sm-10" style="padding: 0;overflow: hidden;margin-top: 10px;">
                                    ...
                                    <div class=" year">
                                       ...
                                       <?php
                                            for($i=0,$j=2018;i<=59,$j>=1958;$i++,$j--){
                                               echo "<option value='$i'>".$j."</option>";
                                            }
                                        ?>
                                    </select>
                            ...
                            <div class="container-login100-form-btn">
                              <div class="wrap-login100-form-btn">
                                ...
                                <button class="login100-form-btn" name="submit">
                                    <input class="inpt" name="submit" type="submit"  value="Edit profile" >
                                </button>
