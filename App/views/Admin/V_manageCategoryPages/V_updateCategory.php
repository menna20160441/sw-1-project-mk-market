		...
		<div class="container-login100">
            <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
                    ...
                    <div class="container">
                        ...
                        <form class="form-horizontal" action='../../controllers/Admin/C_manageCategory.php' method="post">
                            ...
                            <div class="wrap-input100 validate-input m-b-23" data-validate = "Username is reauired">
                                ...
                                <input class="input100" type="text" name="name"  placeholder="Type name of product" value="<?php echo $date['Name']?>" >
