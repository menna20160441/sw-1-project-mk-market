...
<div class="ContentDelete">
 <div class="container-login100">
    <div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54 ">
        <h2 class="headcash">Supervisor</h2>
            ...
            if(empty($SecDataDisplay)){
                ...
                for ($i = 0; $i < count($SecDataDisplay); $i++){
                    ...
                    <tr>
                        ...
                        <td>
                            <a href ='../../controllers/Admin/C_manageEmployee.php?page=ManageCashier&action=update&id={$SecDataDisplay[$i]['ID']}&GroupID=2' class= 'btn btn-info confirm btn-up'><i class='fa fa-edit'></i> Update</a>
                            ...
                            <a href ='../../controllers/Admin/C_manageEmployee.php?page=ManageCashier&action=display&id={$SecDataDisplay[$i]['ID']}&GroupID=2' class = 'btn btn-info confirm btn-up'><i class='fa fa-window-maximize' aria-hidden='true'></i> Display</a>
                        </td>
                    </tr>
                        ";
       ...
       <div class="container-login100-form-btn">
                <div class="wrap-login100-form-btn">
                        ...
                        <button class="login100-form-btn" name="submit">
                            <a style="color:#fff" href="../../controllers/Admin/C_manageEmployee.php?page=ManageEmployee&action=add&GroupID=2">Add New Supetvisor</a>
                        </button>
