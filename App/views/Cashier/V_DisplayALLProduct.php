                ...
                echo " 
                    <tr>
                        ...
                        <td>
                            ...
                            <a href ='../../controllers/Cashier/C_DisplayCategory.php?action=display&id={$item['ID']}' class = 'btn btn-info confirm btn-up'> <i class='fa fa-window-maximize' aria-hidden='true'></i> Display</a>
                        </td>
                    </tr>
                        ";
            }
